...
<h4>Top Airlines</h4>
<img onclick="window.location.href='<?= base_url() ?>'" src="<?= base_url() ?>frontend/images/logo.png" alt="flybookpro logo"/>
</div>
...
<div class="ss-sec">
	 ...
	 <h5><a href='https://goo.gl/maps/hf3H7X476dM4L8e49'><?= ADDRESS ?></a>
...
<div class="ss-sec">
    <i class="fa fa-envelope" aria-hidden="true"></i>
	 ...
	 <h5><a href="mailto:<?= EMAIL ?>"> <?= EMAIL ?></a></h5><div class="clearfix"></div>
...
<div class="container">
 <p> Registered office located at <a href='https://goo.gl/maps/hf3H7X476dM4L8e49'><?=ADDRESS?></a>, in the state of Pennsylvania (USA). We are available to provide customer support on all days from Monday to Sunday. <br><a href='tel:<?=TFN?>'>Customer Service Number: <?=TFN?></a> | <a href="mailto:<?= EMAIL ?>">Email: <?= EMAIL ?></a> <br> © Copyrights 2023. <?= WEBSITE ?>.</p>      
...
-->
<script src="<?= base_url() ?>frontend/bootsrap_V5/bootstrap.bundle.min.js"></script>
