...
define('Airline', 'Etihad Airlines');
...
<div class="about-spirit-airlines content-wrap mb-4 mb-md-4">
   <div class="container">
      ...
      <p>Enjoy cheap flight deals to your destination without compromising on services by booking tickets with Flybookpro. We present numerous deals on various world’s renowned airlines. At Flybookpro, we secure the best deals on Etihad Airlines.
      </p>
      <h3>About</h3>
      ...
      <p>Etihad Airways offers a variety of classes of service, including Economy Class, Premium Economy Class, Business Class, and First Class. The airline's Economy Class seats are spacious and comfortable, and the food is of high quality. Premium Economy Class offers more legroom and wider seats, as well as access to the airline's lounges. Business Class offers lie-flat seats, gourmet meals, and attentive service. First Class offers private suites with lie-flat beds, personal chefs, and butler service.</p>
      
      <p>Here are some additional facts about Etihad Airways:</p>
      <ul>
  <li>Etihad Airways' fleet consists of over 100 aircraft, including Airbus A380s, Boeing 787s, and Boeing 777s.</li>
  <li>Etihad Airways' main hub is Abu Dhabi International Airport.</li>
...
<h3>Book your Etihad Airways flight to the United States with Flybookpro</h3>
<p>Flybookpro is a travel agency that specializes in cheap and easy call only booking. We can help you book your Etihad Airways flight to the United States at the best possible price. We also offer a variety of other travel services, such as hotel reservations, car rentals, and travel insurance.
To book your Etihad Airways flight to the United States with Flybookpro, simply call us at 1-888-811-2217. We'll be happy to help you find the perfect flight for your needs.
</p>
