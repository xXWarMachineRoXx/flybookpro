...
define('Airline', 'Turkish Airlines');


?>
<script>
   document.title = "Book Cheap Flight Ticket on <?= Airline ?> | Get Cheap Flight Deal <?= Airline ?> - Flybookpro";
...
<div id="header-wrapper" class="wrap-inpg py-4 py-md-5"
   style="background-image: url('frontend/images/turkish-airlines.jpg'); background-postion: 5px; background-size: cover;">
...
<div class="about-spirit-airlines content-wrap mb-4 mb-md-4">
   <div class="container">
      ...
      <p>Enjoy cheap flight deals to your destination without compromising on services by booking tickets with Flybookpro. We present numerous deals on various world’s renowned airlines. At Flybookpro, we secure the best deals on Turkish Airlines.
      </p>
      <h3>About</h3>
      <p>Turkish Airlines is the flag carrier airline of Turkey. It is headquartered in Istanbul Atatürk Airport and operates scheduled and charter flights to over 300 destinations in Europe, Asia, Africa, and the Middle East. Turkish Airlines is a member of the Star Alliance.</p>
      <p>Turkish Airlines offers a variety of classes of service, including Economy Class, Business Class, and Comfort Class. The airline's Economy Class seats are spacious and comfortable, and the food is of high quality. Business Class offers lie-flat seats, gourmet meals, and attentive service. Comfort Class offers more legroom and wider seats than Economy Class.</p>
      
      <p>Here are some additional facts about Turkish Airlines:</p>
      <ul>
  <li>Turkish Airlines' fleet consists of over 300 aircraft, including Airbus A330s, A350s, and Boeing 777s.</li>
  <li>Turkish Airlines' main hubs are Istanbul Atatürk Airport and Istanbul Sabiha Gökçen International Airport.</li>
  <li>Turkish Airlines' major destinations in the United States include New York, Los Angeles, Chicago, Miami, and Washington, D.C.</li>
  <li>Turkish Airlines is a member of the Star Alliance, which also includes Lufthansa, United Airlines, Air Canada, and Swiss International Air Lines.</li>
</ul>
<h3>Book your Turkish Airlines flight to the United States with Flybookpro</h3>
<p>Flybookpro is a travel agency that specializes in cheap and easy call only booking. We can help you book your Turkish Airlines flight to the United States at the best possible price. We also offer a variety of other travel services, such as hotel reservations, car rentals, and travel insurance.
To book your Turkish Airlines flight to the United States with Flybookpro, simply call us at 1-888-811-2217. We'll be happy to help you find the perfect flight for your needs.

</p>
      <div class="all-content">
         <h3>Booking Method</h3>
         <p>To book a low-cost flight, passengers must go to the Flybookpro website. Online flight booking saves money
            ...
            also arrange your trip by phoning our reservation number. CFly to any corner of the world including New York, San Francisco, and Chicago. Connect to Flybookpro to book flights to the United States or any other Air France International flight routes. You can connect us at +1 888-811-2217.

         </p>
         <h3>What distinguishes Flybookpro as a rare star?</h3>
         <p>Flybookpro may provide you with happiness and smiles at the lowest cost. There are several inexpensive
