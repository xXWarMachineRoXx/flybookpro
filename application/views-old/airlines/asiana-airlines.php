...
define('Airline', 'Asiana Airlines');
...
<div id="header-wrapper" class="wrap-inpg py-4 py-md-5"
   style="background-image: url('frontend/images/asiana-airlines.jpg'); background-postion: 5px; background-size: cover;">
...
<div class="about-spirit-airlines content-wrap mb-4 mb-md-4">
   <div class="container">
      ...
      <p>Asiana Airlines is a South Korean airline headquartered in Seoul. It is the second largest airline in South
         Korea after Korean Air. Asiana Airlines operates scheduled and charter flights to over 70 destinations in Asia,
         North America, Europe, and Oceania. Asiana Airlines is a member of the Star Alliance.
      </p>
      <h3>About</h3>
      <p>Asiana Airlines offers a variety of classes of service, including Economy Class, Premium Economy Class, and 
         Business Class. The airline's Economy Class seats are spacious and comfortable, and the food is of high quality. 
         Premium Economy Class offers more legroom and wider seats, as well as access to the airline's lounges. 
         Business Class offers lie-flat seats, gourmet meals, and attentive service. </p>
      
      <p>Some additional facts about Asiana Airlines:</p>
      <ul>
         <li>Asiana Airlines' fleet consists of over 80 aircraft, including Boeing 777s, 787s, and Airbus A350s.</li>
         <li>Asiana Airlines' main hubs are Incheon International Airport and Gimpo International Airport.</li>
         <li>Asiana Airlines' major destinations include Los Angeles, New York, London, Paris, Sydney, Singapore, and
            Hong Kong.</li>
         <li>Asiana Airlines is a member of the Star Alliance, which also includes Lufthansa, United Airlines, Air
            Canada, and Swiss International Air Lines.</li>
      </ul>
      <p>Here are some of the features that make Asiana Airlines a popular choice for travelers:
      </p>
      ...
      <p>To book your Asiana Airlines flight with Flybookpro, simply call us at <a class='text-primary' href='tel:<?php echo TFN; ?>'><?php echo TFN; ?></a>. We'll be happy to help you 
find the perfect flight for your needs</p>
      ...
      <div class="all-content">
         ...
         <p>To book a low-cost flight, passengers must go to the Flybookpro website. Online flight booking saves money
            ...
            also arrange your trip by phoning our reservation number. CFly to any corner of the world including New
            York, San Francisco, and Chicago. Connect to Flybookpro to book flights to the United States or any other
            Air France International flight routes. You can connect us at +1 888-811-2217.
         ...
         <p>Flybookpro may provide you with happiness and smiles at the lowest cost. There are several inexpensive
            ...
            <strong>affordable flight journey</strong>.
         </p>
      </div>
