<div class="booking-selection">
  ...
  <ul class="nav nav-tabs" id="myTab" role="tablist">
      <li class="nav-item">
          <button type="button" class="nav-link active" id="home-tab" data-bs-toggle="tab" data-bs-target="#home" role="tab" aria-controls="home" aria-selected="true"><i class="fa fa-plane" aria-hidden="true"></i> Flight</button>
      </li>
...
<div class="destination-box">
                          <div class="element-input exc">
                              ...
                              <input placeholder="Departing from?" class="large" required="" value="" type="text" id="flight-from" style="background: url(<?= base_url("frontend") ?>/img/loca.png) #fff no-repeat left;" onclick="if (this.value != '') {
                                      this.value = ''
                                  }" />
                          ...
                          <div class="element-input">
                              ...
                              <input placeholder="Going to?" value="" required="" class="large" type="text" id="flight-to" style="background: url(<?= base_url("frontend") ?>/img/loca.png) #fff no-repeat left;" onclick="if (this.value != '') {
                                      this.value = ''
                                  }" />
...
<div class="clearfix"></div>
                      <div class="element-search text-center">
                          <button name="submit" id="submit" value="Search Flight" type="submit" class="search-button">BOOK NOW</button>
