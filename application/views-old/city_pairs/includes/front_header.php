    ...
    <div class="header-section head-top" id="header-section">
        <div class="container">
            <nav class="navbar navbar-expand-lg navbar-light ">
                ...
                <a class="navbar-brand" href="#"><img  class='branding-logo-fit' onclick="window.location.href='<?= base_url() ?>'" src="<?= base_url() ?>frontend/images/logo.png" alt="flybookpro logo"/></a>
                <div class="callnow">
