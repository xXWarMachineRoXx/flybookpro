        ...
        <div class="container">
            <nav class="navbar navbar-expand-lg navbar-light ">
                ...
                <div class="collapse navbar-collapse" id="navbarText">
                    <button class="navbar-toggler clsbtn" type="button" data-bs-toggle="collapse"
                        data-bs-target="#navbarText" aria-controls="navbarText" aria-expanded="false"
                        aria-label="Toggle navigation"><span class="ti-close"></span></button>
                    <ul class="navbar-nav me-auto ms-lg-5">
                        ...
                        <li class="nav-item dn-c d-lp"><a class="nav-link" href="<?= base_url() ?>site-map">Site Map</a>
                        </li>
                    </ul>
