...
define('Airline', 'Air New Zealand');
...
<div id="header-wrapper" class="wrap-inpg py-4 py-md-5"
   style="background-image: url('frontend/images/air-new-zealand.jpg'); background-postion: 5px; background-size: cover;">
...
<div class="about-spirit-airlines content-wrap mb-4 mb-md-4">
   <div class="container">
      ...
      <p>Enjoy cheap flight deals to your destination without compromising on services by booking tickets with Flybookpro. We present numerous deals on various world’s renowned airlines. At Flybookpro, we secure the best deals on Air New Zealand.
      </p>
      <h3>About</h3>
      <p>Air New Zealand is the flag carrier airline of New Zealand. It is headquartered in Auckland and operates scheduled and charter flights to over 30 destinations in 18 countries, primarily around and within the Pacific Rim. Air New Zealand is a member of the Star Alliance.</p>
      <p>Air New Zealand offers a variety of classes of service, including Economy Class, Premium Economy Class, and Business Class. The airline's Economy Class seats are spacious and comfortable, and the food is of high quality. Premium Economy Class offers more legroom and wider seats, as well as access to the airline's lounges. Business Class offers lie-flat seats, gourmet meals, and attentive service.</p>
      <p>Here are some additional facts about Air New Zealand:</p>
      <ul>
  <li>Air New Zealand's fleet consists of over 100 aircraft, including Boeing 777s, 787s, and Airbus A320neos.</li>
  <li>Air New Zealand's main hubs are Auckland Airport and Christchurch Airport.</li>
  <li>Air New Zealand's major destinations include Los Angeles, San Francisco, Sydney, Melbourne, Singapore, and Hong Kong.</li>
  <li>Air New Zealand is a member of the Star Alliance, which also includes Lufthansa, United Airlines, Air Canada, and Swiss International Air Lines.</li>
</ul>
<h3>Book your Air New Zealand flight with Flybookpro</h3>
<p>Flybookpro is a travel agency that specializes in cheap and easy call only booking. We can help you book your Air New Zealand flight at the best possible price. To book your Air New Zealand flight with Flybookpro, simply call us at 1-888-811-2217. We'll be happy to help you find the perfect flight for your needs
</p>
