...
<div id="header-wrapper" class="wrap-inpg py-4 py-md-5"
   style="background-image: url('frontend/images/virgin-australia.jpg'); background-position: center;background-no-repeat: no-repeat; background-size: cover;">
...
<div class="about-spirit-airlines content-wrap mb-4 mb-md-4">
   <div class="container">
      ...
      <p>Enjoy cheap flight deals to your destination without compromising on services by booking tickets with Flybookpro. We present numerous deals on various world’s renowned airlines. At Flybookpro, we secure the best deals on Virgin Australia.
      </p>
      <h3>About</h3>
