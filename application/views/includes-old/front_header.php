...
<meta name="description" content="Online Cheap Flights Ticket Booking. Lowest Fares & Best Travel Deals.24/7 Hours Travel Experts Support. Book Now at Flybookpro. For booking information call us @<?=TFN?> Or Mail us - <?= MAIL ?>">
<link rel=“canonical” href=“https://Flybookpro” />
...
<script async src=https://www.googletagmanager.com/gtag/js?id=G-56KSXCZEMK>
...
<script>
  ...
  gtag('config', 'G-56KSXCZEMK');

</script>
</head>
<body>
    <div class="header-section head-top" id="header-section">
        <div class="container">
            <nav class="navbar navbar-expand-lg navbar-light ">
                <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarText" aria-controls="navbarText" aria-expanded="false" aria-label="Toggle navigation">
                <span class="ti-align-left"></span>
                </button>
                <a class="navbar-brand" href="#"><img onclick="window.location.href='<?= base_url() ?>'" src="<?= base_url() ?>frontend/images/logo.png" alt="Flybookpro logo"/></a>
                <div class="callnow">
                ...
                <div class="collapse navbar-collapse" id="navbarText">
                    <button class="navbar-toggler clsbtn" type="button" data-bs-toggle="collapse" data-bs-target="#navbarText" aria-controls="navbarText" aria-expanded="false" aria-label="Toggle navigation"><span class="ti-close"></span></button>
