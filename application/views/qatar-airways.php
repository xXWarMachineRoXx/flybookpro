<script>
document.title = "Book Cheap Flight Ticket on Qatar Airways | Get Cheap Flight Deal Qatar Airways - Flybookpro";       
 ...
 <?php include 'includes/deals.php'; ?>
   ...
   <div class="container mb-3 mb-md-4">
      <div class="flight-list">
		 ...
		 <h3 class="headh3 txt-ff"><span>Qatar Airways</span> Flight Deals <small>(Round Trip)</small> </h3>
