...
<div id="header-wrapper" class="wrap-inpg py-4 py-md-5"
   style="background-image: url('frontend/images/iberia-airlines.jpg'); background-postion: 5px; background-size: cover;">
            ...
            <div class="row g-3">
               <div class="col-md-6 col-12">
                  <div class="flight-status fs-indx bxd">
                     <a title="Flight From Madrid to New York"
                        href="<?= base_url() ?>Result?depart=MAD&arrival=JFK&trip=round&page=1&departOn%5B%5D=<?= D_DATE ?>&returnOn=<?= R_DATE ?>&adult=1&child=0&infant=0&cabin=ECONOMY&airline=">
                        <div class="row align-items-center no-gutters">
                           <div class="col-lg-8 col-8">
                              <div class="dd-box">
                              MAD <i class="ti-exchange-vertical"></i> JFK<br>
                           <span>Madrid to New York</span>
                                 <hr>
                                 <span>
                                    <?= DR_DATE ?>
                                 </span>
                           ...
                           <div class="col-lg-4 col-4">
                              <strong>$479<i class="ti-info-alt price-info"></i></strong>
...
<div class="about-spirit-airlines content-wrap mb-4 mb-md-4">
   <div class="container">
      ...
      <p>Enjoy cheap flight deals to your destination without compromising on services by booking tickets with Flybookpro. We present numerous deals on various world’s renowned airlines. At Flybookpro, we secure the best deals on Iberia Airlines.
      </p>
      <h3>About</h3>
      <p>
        <!-- About content -->
        Iberia Airlines is the flag carrier airline of Spain. It is headquartered in Madrid and operates scheduled and charter flights to over 140 destinations in 26 countries in South America, North America, and the Caribbean. Iberia Airlines is a member of the Oneworld alliance.
      </p>
      <p>
        <!-- Additional facts -->
        Here are some additional facts about Iberia Airlines:
        <ul>
          <li>Iberia Airlines' fleet consists of over 120 aircraft, including Boeing 787s, Airbus A350s, and Airbus A320neos.</li>
          <li>Iberia Airlines' main hubs are Madrid–Barajas Airport and Barcelona–El Prat Airport.</li>
          <li>Iberia Airlines' major destinations in the United States include Miami, New York, Los Angeles, San Francisco, and Orlando.</li>
          <li>Iberia Airlines is a member of the Oneworld alliance, which also includes American Airlines, British Airways, Qantas, and Japan Airlines.</li>
        </ul>
      </p>
<h3>Book your Iberia Airlines flight to the United States with Flybookpro</h3>
<p>
        <!-- Book your flight content -->
        Flybookpro is a travel agency that specializes in cheap and easy call only booking. We can help you book your Iberia Airlines flight to the United States at the best possible price. We also offer a variety of other travel services, such as hotel reservations, car rentals, and travel insurance.

        To book your Iberia Airlines flight to the United States with Flybookpro, simply call us at <a href="tel:1-888-811-2217">1-888-811-2217</a>. We'll be happy to help you find the perfect flight for your needs.
      </p>
      <div class="all-content">
         <h3>Booking Method</h3>
         <p>
            <!-- Booking method content -->
            To book a low-cost flight, passengers must go to the Flybookpro website. Online flight booking saves money
         ...
         <p>
            <!-- What distinguishes Flybookpro content -->
            Flybookpro may provide you with happiness and smiles at the lowest cost. There are several inexpensive
