<script>
document.title = "Book Cheap Flight Ticket on Canadian North | Get Cheap Flight Deal Canadian North - Flybookpro";       
...
document.getElementsByTagName('meta')["description"].content = "Find cheap flight at Flybookpro. Get the best fairs With US - call us @ <?=TFN?>";   
   ...
   <!-- <div id="header-wrapper" class="wrap-inpg py-4 py-md-5 image " style="background-image: url('/Flybookpro/frontend//Flybookpro/frontend/images/canadian-north.png'); background-position: bottom;background-no-repeat: no-repeat; background-size: cover;"> -->
 ...
 <?php include 'includes/deals.php'; ?>
   ...
   <div class="container mb-3 mb-md-4">
      <div class="flight-list">
		 ...
		 <h3 class="headh3 txt-ff"><span>Canadian North</span> Flight Deals <small>(Round Trip)</small> </h3>
...
<script>
$('.airline-name').text('Canadian North');
