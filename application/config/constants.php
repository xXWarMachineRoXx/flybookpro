...
defined('EMAIL_B') or define('EMAIL_B', "info@flybookpro.com");
defined('EMAIL_S') or define('EMAIL_S', "info@flybookpro.com");
defined('EMAIL_SALE') or define('EMAIL_SALE', "info@flybookpro.com");
defined('EMAIL_SER') or define('EMAIL_SER', "info@flybookpro.com");
defined('EMAIL_CON') or define('EMAIL_CON', "info@flybookpro.com");
